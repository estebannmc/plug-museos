...
Muestra propuestas publicadas cuyo estado calculado sea `ACTIVA`. Puede mostrar todas las categorías, una o varias categorías elegidas, y tomar la configuración por defecto desde Programación de Museos > Ajustes del slider.
...
Estados incluidos en el slider. Acepta `activa` o `activa,proximamente`.
...
* `capital-cultural-programacion-v201.php`: bootstrap y cabecera del plugin.
